...
const FlashScreen:React.FC = () => {
    ...
    return (
        <div className="fixed inset-0 bg-[#222326] text-white flex flex-col justify-center items-center">
            ...
            <div className="relative w-3/4 h-4 bg-gray-700 rounded-full overflow-hidden z-10">
                <div
                    ...
                    className="h-full bg-[#193782] transition-all ease-out duration-300"
                />
            </div>
        </div>
    );
