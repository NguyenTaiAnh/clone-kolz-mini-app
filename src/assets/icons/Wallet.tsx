...
const Wallet: React.FC<IconProps> = ({ size = 20, className = '' }) => {
  ...
  return (
    ...
    >
      <path
        d='M20 7.96995V10.03C20 10.58 19.56 11.03 19 11.05H17.04C15.96 11.05 14.97 10.26 14.88 9.17995C14.82 8.54995 15.06 7.95995 15.48 7.54995C15.85 7.16995 16.36 6.94995 16.92 6.94995H19C19.56 6.96995 20 7.41995 20 7.96995Z'
        fill='white'
      />
      <path
